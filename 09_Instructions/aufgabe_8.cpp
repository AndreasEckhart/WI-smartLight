...
void loop() {
  // NICHT-BLOCKIERENDE Variante: Einzelnes Pixel wandert im Kreis
  // Diese Variante nutzt updateErforderlich() statt delay() - dadurch bleibt
  // das Programm reaktiv (z.B. für Buttons oder andere Sensoren)
