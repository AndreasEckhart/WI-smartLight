...
:: ==========================================================
:: SCHRITT 3: PLATFORMIO EXTENSION INSTALLATION (USER)
:: ==========================================================
echo.
echo === 3/5 Installiere PlatformIO Extension ===
...
:: ==========================================================
:: SCHRITT 4: KONFIGURATION ANWENDEN & COPILOT DEAKTIVIEREN (USER)
:: ==========================================================
echo.
echo === 4/5 Kopiere Master-Settings.json und deaktiviere Copilot ===
...
:: ==========================================================
:: SCHRITT 5: VS CODE STARTEN
:: ==========================================================
echo.
echo === 5/5 Starte VS Code ===
if exist %VSCODE_PATH%.exe (
    start "" %VSCODE_PATH%
